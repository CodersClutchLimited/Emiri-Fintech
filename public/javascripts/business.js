const content = {
    section1: {
        ...
        body: "Innowise creates custom-built solutions for financial, banking, and insurance industries, <br> bringing in 16+ years of experience in IT.",
        image: "https://diceus.com/wp-content/uploads/2023/09/og_cover_1-1.jpg"
    },
    section2: {
        title: "FinTech software support",
        body: "Our company provides software maintenance services to ensure its reliability, <br> operability, security, and regulation compliance.",
    ...
    section3: {
        ...
        body: "As a leading IT advisory, Innowise offers expert guidance on navigating financial <br> technology, from market analysis to regulatory requirements and strategic planning.",
    ...
    section4: {
        ...
        body: "We connect FinTech solutions with your existing systems so they work together <br> smoothly — automating data flow and giving you better insights across all your platforms.",
    ...
    section5: {
        ...
        body: "If you need stronger data protection, we’re here to help — we can audit your current <br> setup, add data encryption, and set up role-based access to keep your FinTech systems secure.",
    ...
    section6: {
        ...
        body: "Our A-level developers build banking software solutions that guarantee robust data <br> security, compliance with regulatory standards, and accessible banking services to the customers.",
    ...
    section7: {
        ...
        body: "At Innowise, we develop insurance software that automates and streamlines everything <br> from claims and policy management to underwriting, billing, and actuarial modeling.",
    ...
    section8: {
        ...
        body: "Our skilled teams of software engineers help businesses comprehend the pros of <br> digitization and embrace business transformation to step on another level of financial efficiency.",
    ...
    section9: {
        ...
        body: "Our experts use blockchain to build decentralized trading and asset management <br> platforms where security is unbreakable and transparency isn’t just a feature — it’s the foundation.",
    ...
    section10: {
        ...
        body: "Innowise offers top-tier crypto software development services, ensuring unwavering <br> security and convenience for users to manage their digital assets.",
    ...
    section11: {
        ...
        body: "With our profound assistance, upgrading obsolete software and adding new features to <br> the existing solutions go smoothly, with no interruptions to the business.",
    ...
    section12: {
        ...
        body: "We help companies design secure, compliant solutions that automate the collection, <br> storage, and analysis of financial information to improve risk management for businesses.",
...
document.querySelectorAll('.left-column a').forEach(link => {
    link.addEventListener('click', (event) => {
        ...
        <div class="aday divares">
            <h2 class="content-title font-bold john-text">${content[section].title}</h2>
